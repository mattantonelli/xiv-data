...
.\SaintCoinach.Cmd.exe %GAMEPATH% "allexd Achievement AchievementCategory AchievementKind Action ActionTransient Addon AozActionTransient BannerBg BannerDecoration BannerFrame BuddyEquip CharaCardBase CharaCardDecoration CharaCardHeader Companion CompanionMove CompanionTransient ContentFinderCondition Emote EmoteCategory Item MinionRace MinionSkillType Mount MountTransient MYCWarResultNotebook Orchestrion OrchestrionCategory Ornament Quest TextCommand Title VVDNotebookContents VVDNotebookSeries"
.\SaintCoinach.Cmd.exe %GAMEPATH% "rawexd Achievement AozAction BannerCondition Cabinet CabinetCategory CharaMakeCustomize Emote GCScripShopItem GilShopItem InstanceContent Item ItemAction OrchestrionPath OrchestrionUiParam PvPSeries Recipe SpecialShop VVDNotebookSeries"
