...
.\SaintCoinach.Cmd.exe %GAMEPATH% "rawexd Achievement AozAction BannerCondition Cabinet CabinetCategory CharaMakeCustomize Emote GCScripShopItem GilShopItem InstanceContent ItemAction OrchestrionPath OrchestrionUiParam PvPSeries Recipe SpecialShop VVDNotebookSeries"
