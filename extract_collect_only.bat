...
.\SaintCoinach.Cmd.exe %GAMEPATH% "allexd Achievement AchievementCategory AchievementKind Action AozActionTransient BuddyEquip CabinetCategory Companion CompanionMove CompanionTransient ContentFinderCondition Emote EmoteCategory Item MinionRace MinionSkillType Mount MountTransient Orchestrion OrchestrionCategory Quest Recipe TextCommand"
.\SaintCoinach.Cmd.exe %GAMEPATH% "rawexd Achievement AozAction Cabinet CharaMakeCustomize ItemAction"
